...
public class LoginController {
	...
	private void onLoginClicked() {
        ...
        if (isAuthenticated) {
            ...
            try {
            	FXMLLoader loader = new FXMLLoader(getClass().getResource("/resources/fxml/HomePage.fxml"));
    ...
    private void onRegisterClicked() {
    	try {
        	FXMLLoader loader = new FXMLLoader(getClass().getResource("/resources/fxml/registerPage.fxml"));
        	Parent root = loader.load();
