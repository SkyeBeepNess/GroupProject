package logreghome.controllers;

import java.util.List;

import applicantDetails.dbhandler.*;
...
public class HomeController {
	...
	private void onCoursesClicked() { 
		try { //courseSelection.src.main.CourseBookingApp.main(null);
			NavigationService.navigateTo("CourseBookingDashboard.fxml", "Course Selection");
		}
		catch (Exception e) {
            e.printStackTrace();
            UIServices.showWorkings(); 
		}
	}
	@FXML
	...
	@FXML
	private void onSportClicked() { 
		sportSchool.SourceCode.main(null);
	}
